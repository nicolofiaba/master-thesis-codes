...
# ---------------------------------------------------------------------------------
hdu_rect = fits.open("/scratch/astro/nicolo.fiaba/training_sets/labels_RGS000_minus4.fits", memmap=True)
hdu_rect_masked = fits.open("/scratch/astro/nicolo.fiaba/training_sets/train_RGS000_minus4.fits", memmap=True)
...
unet_model.save("/scratch/astro/nicolo.fiaba/trained_models/unet_model_minus4_000.h5")

print("U-Net trained and saved!")

import pickle
with open('/scratch/astro/nicolo.fiaba/trained_models/UNET_hist_minus4_000', 'wb') as file_pi:
