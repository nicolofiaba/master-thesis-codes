...
# ---------------------------------------------------------------------------------
hdu_rect = fits.open("/scratch/astro/nicolo.fiaba/training_sets/labels_RGS180_0.fits", memmap=True)
hdu_rect_masked = fits.open("/scratch/astro/nicolo.fiaba/training_sets/train_RGS180_0.fits", memmap=True)
...
unet_model.save("/scratch/astro/nicolo.fiaba/trained_models/unet_model_0_180.h5")

print("U-Net trained and saved!")

import pickle
with open('/scratch/astro/nicolo.fiaba/trained_models/UNET_hist_0_180', 'wb') as file_pi:
